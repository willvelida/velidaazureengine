variable "resource_group_name" {
  default = "myhealthapiexercise-rg"
}
...
variable "function_storage_name" {
  default = "samyhealthapiexercise"
  description = "Name of the storage account for MyHealth.API.Exercise"
  type = string
}

variable "myhealth_api_exercise_function_name" {
  default = "famyhealthapiexercise"
  description = "Name of the MyHealth.API.Exercise App"
  type = string
}
