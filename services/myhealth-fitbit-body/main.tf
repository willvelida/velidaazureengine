terraform {
    backend "azure" {
      ...
      container_name = "myhealthfitbitbodytfstate"
...
module "resource_group" {
    ...
    resource_group_tags = {
        ...
        "ServiceName" = "MyHealth.Fitbit.Body"
    }  
}
...
# Create storage account for MyHealth.Fitbit.Body
...
# Create Function App for MyHealth.Fitbit.Body
resource "azurerm_function_app" "fitbitbody" {
  name = var.myhealth_fitbit_body_function_name
