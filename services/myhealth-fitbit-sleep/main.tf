terraform {
    backend "azure" {
      ...
      container_name = "myhealthfitbitsleeptfstate"
...
module "resource_group" {
    ...
    resource_group_tags = {
        ...
        "ServiceName" = "MyHealth.Fitbit.Sleep"
    }  
}
...
resource "azurerm_function_app" "fitbitsleep" {
  name = var.myhealth_fitbit_sleep_function_name
...
resource "azurerm_key_vault_access_policy" "velidakeyvault_policy" {
  ...
  object_id = azurerm_function_app.fitbitsleep.identity[0].principal_id
